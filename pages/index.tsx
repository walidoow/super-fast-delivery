...
const TEXTS = [
  ...
  'Delivering Speed, Exceeding Expectations!',
  'Swift Service, Superior Satisfaction!'
];
...
export default function Home() {
  ...
  return (
    <main className="font-roboto-Roboto bg-primary-yellow-green h-full">
      <ScrollArea className={"w-full h-full"}>
        <div
          className="p-6 h-52 bg-gradient-to-r slide-in-from-right-64 from-primary-mint-green via-primary-orange to-primary-mint-green border-t-2 border-black">
          <div id="logo-and-track">
            <div>
              <h1
                className="text-primary-dark-grey font-bold font-roboto-Roboto text-4xl">
                <TextTransition springConfig={presets.wobbly}>{TEXTS[index % TEXTS.length]}</TextTransition></h1>
            </div>
            <div className="mt-10">
        ...
        <div
          className="font-roboto-Roboto h-11 bg-primary-dark-grey align-middle text-2xl text-slate-50 text-center">Delivery
          done <span className="text-primary-orange">right</span> (and <span className="primary-orange">fast</span>).
        </div>
        <div className="min-h-screen m-9 grid grid-cols-1 items-center">
          <div className="flex items-center justify-center" id="item-and-text">
            <div
              className="p-4 backdrop-blur-sm drop-shadow-md w-64  rounded-xl bg-gradient-to-b from-primary-mint-green to-primary-yellow-green">
              <span>Payment powered by</span>
              <img className="mb-6" src="https://i.imgur.com/fhoI0MY.png"></img>
            </div>
            <div className="ml-16"><span className="text-2xl">Payment made <span
              className="text-primary-orange">easy</span></span><br/>
              We use <span className="text-stripe-purple">Stripe</span> to process our transactions, <br/> ensuring a
              secure,swift, and reliable payment process <br/>for our customers.
            </div>
          </div>
          <div className="flex items-center content-center justify-center" id="item-and-text-switch">
            <div className="mr-16"><span className="text-2xl">Quotations on the <span
              className="text-primary-orange">fly</span></span><br/>
              We provide personalized quotations for <br/>each delivery order at the click of a button.
            </div>
            <div
              className="p-4 backdrop-blur-sm drop-shadow-md w-64  rounded-xl bg-gradient-to-b from-primary-mint-green to-yellow-green">
          ...
          <div className="flex items-center content-center justify-center" id="item-and-text">
            ...
            <div className="ml-16"><span className="text-2xl">Customer Service <span
              className="text-primary-orange">24/7</span></span><br/>
              Our customer service team works around the clock to ensure <br/> you get the best service possible.
              Our team is readily available <br/> through<span className="text-primary-orange"> Zoom </span> Online
              chat,
              and more!
            </div>
          </div>
        ...
        <div id="reviews-preview" className="mb-10">
          <div className="bg-opacity-80 w-full justify-center bg-primary-orange flex items-center gap-8 p-8">
            ...
            <div
              className="p-4 backdrop-blur-sm drop-shadow-md w-64  rounded-xl bg-gradient-to-b from-primary-mint-green to-primary-yellow-green">
              <div id="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                ut
